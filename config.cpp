...
class CfgAmmo
{
    ...
    class JCA_B_556x45_Ball_M995AP: JCA_B_556x45_Ball // ACE_556x45_Ball_M995_AP https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L168
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={687,753,799,838,854,875,888}; // Muzzle Velocities shift +8m/s at 70°F (21°C), 752m/s (10.3"), 830m/s (14.5") at 15°C
...
class CfgMagazineWells
{
    ...
    class STANAG_556x45
    {
        ...
        JCA_Magazines[]= // Weapon initSpeed -1 with ACE_barrelLength 508mm (20"): 926, 940, 990, 838, 950, 880, 283m/s at ICAO standart conditions (15°C, 1013.25 hPa, 0%) according to JCA_30Rnd_556x45 magazines initSpeed
...
class CfgWeapons
{
    ...
    {
        ACE_barrelLength=261.62; // 10.3" CQBR barrel length
        initSpeed=-0.8545; // 791, 803, 846, 716, 752, 242m/s according to ACE_muzzleVelocities at ICAO conditions (15°C, 1013.25hPa, 0%), JCA 800
        class WeaponSlotsInfo: WeaponSlotsInfo
        {
