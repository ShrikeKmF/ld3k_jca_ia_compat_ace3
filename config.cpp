...
class CfgAmmo
{
    ...
    class JCA_B_9x19_Ball_MP5_FMJ: BulletBase // M17 Sig Sauer NATO 9x19mm +P 124gr FMJ https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ...
        ACE_ballisticCoefficients[]={0.285}; // recalculated ICAO G1 BC based on Sig Sauer 2024 datas https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
        ACE_velocityBoundaries[]={};
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_barrelLengths[]={101.6,127.0,228.6}; // default ACE3 4", 5", 9" barrel lengths
        ACE_muzzleVelocities[]={366,396,426}; // at 21°C (70°F: Temp vs MV chart zero), 365m/s (1198fps) 4" barrel - 424m/s (1391fps) 8.858" (225mm) barrel at 15°C (ICAO: 15°C, 1013.25 hPa, 0%) according to JCA_MP5A5 initSpeed
        hit=5.4; // B_9x21_Ball 5, 722 Joules
        indirectHit=0;
        indirectHitRange=0;
        cartridge="FxCartridge_9mm";
        cost=100;
        typicalSpeed=424; // JCA_30Rnd_9x19_MP5_FMJ_Mag and JCA_30Rnd_9x19_MP5_JHP_Mag initSpeed
        airFriction=-0.0012941; // ACE3 -0.00201185, B_9x21_Ball -0.0016, airFrictionAnalysis.txt in docs folder
        caliber=1.2;
        deflecting=25;
    ...
    class JCA_B_9x19_Ball_MP5_JHP: JCA_B_9x19_Ball_MP5_FMJ // M17 Sig Sauer NATO 9x19mm +P 124gr V-Crown https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ...
        ACE_bulletMass=8.035; // 124gr
        ACE_ammoTempMuzzleVelocityShifts[]={-2.655,-2.547,-2.285,-2.012,-1.698,-1.280,-0.764,-0.153,0.596,1.517,2.619}; // default ACE_ammoTempMuzzleVelocityShifts values /10. Muzzle velocity shift 0 at 70°F (21°C), -1m/s at 15°C
        ACE_ballisticCoefficients[]={0.249}; // recalculated ICAO G1 BC based on Sig Sauer 2024 datas https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
        ACE_velocityBoundaries[]={};
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_barrelLengths[]={101.6,127.0,228.6}; // default ACE3 4", 5", 9" barrel lengths
        ACE_muzzleVelocities[]={366,396,426}; // at 21°C (70°F: Temp vs MV chart zero), 365m/s (1198fps) 4" barrel - 424m/s (1391fps) 8.858" (225mm) barrel at 15°C (ICAO: 15°C, 1013.25 hPa, 0%) according to JCA_MP5A5 initSpeed
        hit=9; // B_9x21_Ball 5, 722 Joules
        airFriction=-0.0014822; // airFrictionAnalysis.txt in docs folder
    ...
    class JCA_B_556x45_Ball: BulletBase // ACE3 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L117
    {
        ...
        ACE_ballisticCoefficients[]={0.149}; // ASM BC converted to ICAO 0.149012 for airFriction and dispersion calculation
        ACE_velocityBoundaries[]={};
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=7;
        // ACE_muzzleVelocities[]={723,764,796,825,843,866,878,892,906,915,922,900}; default ACE3 B_556x45_Ball
        ACE_muzzleVelocities[]={731,772,804,833,851,874,886,900,914,923,930,908}; // Muzzle Velocities shift +8m/s at 70°F (21°C) 917m/s 18.1" barrel (459.74mm), at 15°C 909m/s 18.1" barrel (459.74mm) according to ACE3 weapon initSpeed -1
    ...
    class JCA_B_556x45_Ball_Dual: JCA_B_556x45_Ball // 5.56mm underwater subsonic DSG Technology https://dsgtec.com/ https://www.thefirearmblog.com/blog/2017/04/20/dsg-technology-underwater-ammo/
    {
        ...
        ACE_ammoTempMuzzleVelocityShifts[]={-2.655,-2.547,-2.285,-2.012,-1.698,-1.280,-0.764,-0.153,0.596,1.517,2.619}; // default ACE_ammoTempMuzzleVelocityShifts values /10. Muzzle velocity shift 0 at 70°F (21°C), -1m/s at 15°C
        ACE_ballisticCoefficients[]={0.149}; // ASM BC converted to ICAO 0.149012 for airFriction calculation
        ACE_velocityBoundaries[]={};
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=7;
    ...
    class JCA_B_762x51_AP: JCA_B_762x51_Ball // ACE_762x51_Ball_M993_AP https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L351
    {
        ACE_caliber=7.85; // https://bobp.cip-bobp.org/uploads/tdcc/tab-i/tabical-en-page125.pdf
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        // ACE_muzzleVelocities[]={875,910,930}; default ACE_762x51_Ball_M993_AP
        ACE_muzzleVelocities[]={883,918,938}; // muzzle velocities 900 / 938 m/s at 21°C (70°F: Temp vs MV chart zero), 892 / 930 m/s at 15°C (ICAO: 15°C, 1013.25 hPa, 0%) according to JCA_arifle_SR10 / SR25 initSpeed
        ACE_barrelLengths[]={330.2,406.4,508}; // SR10 14.5" (368.3mm) / SR25 20" (508mm) 3D models' barrel lengths
        hit=11;
        typicalSpeed=910;
        caliber=2.2;
...
class CfgMagazines
{
    ...
    class JCA_30Rnd_9x19_MP5_FMJ_Mag: CA_Magazine // M17 Sig Sauer NATO 9x19mm +P 124gr Full Metal Jacket FMJ
    {
        ...
        initSpeed=424; // according to ACE_muzzleVelocities 8.858" barrel (225mm) ICAO conditions (15°C, 1013.25hPa, 0%), JCA 370
        tracersEvery=0;
        lastRoundsTracer=0;
...
class CfgMagazineWells
{
    ...
    class JCA_MP5_9x19 // Weapon initSpeed -1 with ACE_barrelLength 225mm, 424m/s at ICAO standart conditions (15°C, 1013.25 hPa, 0%) according to JCA_30Rnd_9x19_MP5_FMJ_Mag and JCA_30Rnd_9x19_MP5_JHP_Mag initSpeed
    {
        JCA_Magazines[]=
        {
...
class CfgWeapons
{
    ...
    class JCA_smg_MP5_base_F: Rifle_Short_Base_F // https://www.heckler-koch.com/en/Products/Military%20and%20Law%20Enforcement/Submachine%20guns/MP5?section=variants&s=true
    {
        ...
        initSpeed=-1; // 424m/s, 225mm barrel, according to ACE_muzzleVelocities at ICAO conditions (15°C, 1013.25hPa, 0%), JCA 375
        magazines[]=
        { // Priority to JCA magazines first
            "JCA_30Rnd_9x19_MP5_FMJ_Mag",
            "JCA_30Rnd_9x19_MP5_JHP_Mag",
        ...
        class Single: Mode_SemiAuto
        {
            dispersion=0.000639; // 3.91 MOA (*0.562*0.000291), 0.562 value from https://github.com/acemod/ACE3/pull/5755, JCA 0.00116 (3.99 MOA)
        };
