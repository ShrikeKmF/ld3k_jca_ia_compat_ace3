...
class CfgAmmo
{
    ...
    class JCA_B_9x19_Ball_P320C_FMJ: BulletBase // M1152 Sig Sauer 9x19mm 115gr Full Metal Jacket FMJ https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
    {
        ...
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={362}; // Muzzle Velocity shift +1m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 361m/s (1185fps) ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_P320 initSpeed, 1185fps barrel length 4.0" ± 1/16" (± 3.9375", 4.0625") https://www.sigsauer.com/9mm-115gr-elite-ball-fmj.html,
    ...
    class JCA_B_9x19_Ball_P320C_JHP: JCA_B_9x19_Ball_P320C_FMJ // M1153 Sig Sauer 9x19mm 147gr Jacketed Hollow Point JHP https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={301}; // Muzzle Velocity shift +1m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 300m/s (985fps) ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_P320 initSpeed, 985fps barrel length 4.0" ± 1/16" (± 3.9375", 4.0625") https://www.sigsauer.com/9mm-147gr-elite-v-crown-jhp-20ct.html
        ACE_barrelLengths[]={99}; // 3.9" P320 Compact barrel length https://www.sigsauer.com/p320-compact.html
    ...
    class JCA_B_9x19_Ball_P226_FMJ: BulletBase // M17 Sig Sauer NATO 9x19mm +P 124gr Full Metal Jacket FMJ https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ...
        ACE_muzzleVelocities[]={366,398,430}; // Muzzle Velocities shift +1m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 365m/s (1198fps) 4" barrel, 378m/s (1240fps) 4.4" (112mm) barrel ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_P226 initSpeed
    ...
    class JCA_B_9x19_Ball_P226_SUB: JCA_B_9x19_Ball_P226_FMJ // M1153 Sig Sauer 9x19mm 147gr Jacketed Hollow Point JHP https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
    {
        ...
        ACE_dragModel=1;
        ACE_barrelLengths[]={101.6,127,228.6}; // default ACE3 4", 5", 9" barrel lengths
        ACE_muzzleVelocities[]={301,327,354}; // Muzzle Velocities shift +1m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 300m/s (985fps) 4" barrel, 311m/s (1020fps) 4.4" (112mm) barrel ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_P226 initSpeed
    ...
    class JCA_B_9x19_Ball_MP5_FMJ: BulletBase // M17 Sig Sauer NATO 9x19mm +P 124gr FMJ https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ...
        ACE_dragModel=1;
        ACE_barrelLengths[]={101.6,127,228.6}; // default ACE3 4", 5", 9" barrel lengths
        ACE_muzzleVelocities[]={366,398,430}; // Muzzle Velocities shift +1m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 365m/s (1198fps) 4" barrel, 428m/s (1404fps) 8.858" (225mm) barrel ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_MP5A5 initSpeed
    ...
    class JCA_B_45ACP_Ball_Mk23: BulletBase // Winchester Law Enforcement .45 ACP +P 230gr, 990fps (302m/s) barrel length 5" https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
    {
        ...
        ACE_ballisticCoefficients[]={0.209}; // 1020fp/s 149mm, ICAO G1 BC from exterior ballistic app "EBC V2" based on https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
        ACE_standardAtmosphere="ICAO";
        // ACE_ballisticCoefficients[]={0.203}; // 1020fp/s 149mm, ASM G1 BC from exterior ballistic app "EBC V2" based on https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
        // ACE_standardAtmosphere="ASM";
        ACE_velocityBoundaries[]={};
        ACE_dragModel=1;
        ...
        airFriction=-0.00105488; // airFrictionAnalysis.txt in docs folder
        tracerScale=0.6;
    ...
    class JCA_B_45ACP_Ball_Mk23_Tracer_Green: JCA_B_45ACP_Ball_Mk23
    {
        model="\A3\Weapons_f\Data\bullettracer\tracer_green";
    };
    class JCA_B_45ACP_Ball_Mk23_Tracer_Yellow: JCA_B_45ACP_Ball_Mk23
    {
        model="\A3\Weapons_f\Data\bullettracer\tracer_yellow";
    };
    ...
    class JCA_B_556x45_Ball: BulletBase // M855, ACE3 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L117
    {
        ...
        ACE_muzzleVelocities[]={723,792,840,881,898,920,934}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 791m/s (10.3"), 873m/s (14.5"), 926m/s (20") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_M4/M16 initSpeed
    ...
    class JCA_B_556x45_Ball_M855A1: JCA_B_556x45_Ball // M855A1 Lake City Army Ammunition Plant, 2022/23 article https://www.ar15.com/forums/AR-15/M855A1-Accuracy-and-Velocity-updated-/16-783286/
    {
        ...
        ACE_muzzleVelocities[]={734,804,853,894,911,934,948}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 803m/s (10.3"), 886m/s (14.5"), 940m/s (20") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_M4/M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M4A1 CQB, M4A4, M4A4 EGLM 10.3" (261.62mm), M4A1, M4A1 EGLM 14.5" (368.3mm), M16A4 20" (508mm) barrels lengths
    ...
    class JCA_B_556x45_Ball_M193: JCA_B_556x45_Ball // M193 RUAG Ammotec AG
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={772,846,898,941,960,983,998}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 846m/s (10.3"), 933m/s (14.5"), 990m/s (20") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_M4/M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M4A1 CQB, M4A4, M4A4 EGLM 10.3" (261.62mm), M4A1, M4A1 EGLM 14.5" (368.3mm), M16A4 20" (508mm) barrels lengths
    ...
    class JCA_B_556x45_Ball_Mk262: JCA_B_556x45_Ball // ACE_556x45_Ball_Mk262 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L141
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={655,717,761,798,813,833,846}; // Muzzle Velocities shift +8m/s at 70°F (21°C), 716m/s (10.3"), 790m/s (14.5"), 838m/s (20") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_M4/M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M4A1 CQB, M4A4, M4A4 EGLM 10.3" (261.62mm), M4A1, M4A1 EGLM 14.5" (368.3mm), M16A4 20" (508mm) barrels lengths
    ...
    class JCA_B_556x45_Ball_Mk318: JCA_B_556x45_Ball // ACE_556x45_Ball_Mk318 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L155
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={742,812,862,904,921,944,958}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 812m/s (10.3"), 896m/s (14.5"), 950m/s (20") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_M4/M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M4A1 CQB, M4A4, M4A4 EGLM 10.3" (261.62mm), M4A1, M4A1 EGLM 14.5" (368.3mm), M16A4 20" (508mm) barrels lengths
    ...
    class JCA_B_556x45_Ball_M995AP: JCA_B_556x45_Ball // ACE_556x45_Ball_M995_AP https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L168
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={687,753,799,838,854,875,888}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 752m/s (10.3"), 830m/s (14.5"), 880m/s (20") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_M4/M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M4A1 CQB, M4A4, M4A4 EGLM 10.3" (261.62mm), M4A1, M4A1 EGLM 14.5" (368.3mm), M16A4 20" (508mm) barrels lengths
        hit=9.3; // 1757 Joules
    ...
    class JCA_B_556x45_Ball_Dual: JCA_B_556x45_Ball // 5.56mm underwater subsonic DSG Technology https://dsgtec.com https://www.youtube.com/@DSGTechnology/videos https://www.thefirearmblog.com/blog/2017/04/20/dsg-technology-underwater-ammo
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=7;
        ACE_muzzleVelocities[]={220,241,255,268,273,280,284}; // Muzzle Velocities shift +1m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 242m/s (10.3"), 267m/s (14.5"), 283m/s (20") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_M4/M16 initSpeed
        ACE_barrelLengths[]={203.2,254,304.8,368.3,406.4,457.2,508}; // M4A1 CQB, M4A4, M4A4 EGLM 10.3" (261.62mm), M4A1, M4A1 EGLM 14.5" (368.3mm), M16A4 20" (508mm) barrels lengths
        // cartridge="FxCartridge_65";
    ...
    class JCA_B_762x51_Ball: BulletBase // ACE_762x51_Ball_Mk316_Mod_0 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L317
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={757,767,777,792,807,812}; // Muzzle Velocities shift +2m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 770m/s (14.5"), 790 m/s (20") ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_SR10/SR25 initSpeed
    ...
    class JCA_B_762x51_M993AP: JCA_B_762x51_Ball // ACE_762x51_Ball_M993_AP https://www.nammo.com/product/our-products/ammunition/small-caliber-ammunition/7-62mm-series/7-62-mm-x-51-armor-piercing-8-m993/
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={897,909,920,938,958,962}; // Muzzle Velocities shift +8m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 906m/s (14.5"), 930 m/s (20") ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_SR10/SR25 initSpeed
        ACE_barrelLengths[]={254,330.2,406.4,508,609.6,660.4}; // SR10 14.5" (368.3mm), SR25 20" (508mm) barrels lengths
    ...
    class JCA_B_762x51_Subsonic: JCA_B_762x51_Ball // Lapua subsonic B416, 325m/s 16" (406.4mm) barrel (Trajectory charts) https://www.lapua.com/product/308-win-subsonic-fmjbt-tactical-cartridge-13g-200gr-4317340/
    {
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={318,322,326,332,339,341}; // Muzzle Velocities shift +1m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 323m/s (14.5"), 331m/s (20") ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_SR10/SR25 initSpeed
        ACE_barrelLengths[]={254,330.2,406.4,508,609.6,660.4}; // SR10 14.5" (368.3mm), SR25 20" (508mm) barrels lengths
    ...
    class JCA_B_338LM_Ball: B_338_Ball // B_338_Ball, Lapua .338 LM Scenar 250gr GB488 https://www.lapua.com/product/338-lapua-mag-tactical-target-cartridge-scenar-162g-250gr-4318017/
    {
        ...
        ACE_muzzleVelocities[]={908}; // Muzzle Velocities shift +2m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 906m/s (27") ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_5Rnd_338LM_Mag initSpeed
    ...
    class JCA_B_338LM_AP_Ball: JCA_B_338LM_Ball // Lapua .338 LM 248gr AP485 Armor Piercing https://www.lapua.com/product/338-lapua-mag-tactical-cartridge-armor-piercing-161g-248gr-4318035/
    {
        ...
        ACE_muzzleVelocities[]={908}; // Muzzle Velocities shift +2m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 906m/s (27") ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_5Rnd_338LM_AP_Mag initSpeed
        ACE_barrelLengths[]={685.8}; // 27"
    ...
    class JCA_B_338LM_API_Ball: JCA_B_338LM_Ball // Lapua .338 LM 253gr API526 Armor Piercing Incendiary https://www.lapua.com/product/338-lapua-mag-tactical-cartridge-api526-164g-253gr-4318048/
    {
        ...
        ACE_muzzleVelocities[]={898}; // Muzzle Velocities shift +2m/s at 70°F (21°C) (70°F: Temp vs MV chart zero), 896m/s (27") ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_5Rnd_338LM_API_Mag initSpeed
        ACE_barrelLengths[]={685.8}; // 27"
...
class CfgMagazines
{
    ...
    class JCA_15Rnd_9x19_P320C_FMJ_Mag: CA_Magazine // M1152 Sig Sauer 9x19mm 115gr Full Metal Jacket FMJ
    {
        ...
        count=15;
        mass=5.6; // magazine 15 rounds empty 76g + 15x 11.9g, 16Rnd_9x21_Mag 6, JCA 6
    ...
    class JCA_15Rnd_9x19_M9A1_FMJ_Mag: CA_Magazine // M17 Sig Sauer NATO 9x19mm +P 124gr Full Metal Jacket FMJ
    {
        ...
        picture="\weapons_f_JCA_IA\MagazineProxies\data\UI\Icon_15Rnd_9x21_M9A1_Mag_CA.paa";
        ammo="JCA_B_9x19_Ball_M9A1_FMJ";
        type=16; // 16Rnd_9x21_Mag
        count=15;
        mass=6.1; // magazine 15 rounds empty 91g + 15x 12.3g, 16Rnd_9x21_Mag 6, JCA 6
    ...
    class JCA_15Rnd_9x19_M9A1_SUB_Mag: JCA_15Rnd_9x19_M9A1_FMJ_Mag // M1153 Sig Sauer 9x19mm 147gr Jacketed Hollow Point JHP
    {
        ...
        mass=6.6; // magazine 15 rounds empty 91g + 15x 13.9g, 16Rnd_9x21_Mag 6, JCA 6
    ...
    class JCA_12Rnd_45ACP_Mk23_Mag: CA_Magazine
    {
        ...
        initSpeed=311; // according to ACE_muzzleVelocities Mk23 barrel 149mm ICAO conditions (15°C, 1013.25hPa, 0%), JCA 370
    };
    ...
    {
        mass=9.7; // magazine 219g + 5x 44.5g, 10Rnd_338_Mag 14, JCA 8
...
{
    class JCA_P320_Compact_9x19 // Weapon initSpeed -1 with ACE_barrelLength 99mm (3.9"): 361, 300m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_15Rnd_9x19_P320C magazines initSpeed
    {
        JCA_Magazines[]=
        {
    ...
    class JCA_P226_9x19 // Weapon initSpeed -1 with ACE_barrelLength 112mm (4.4"): 378, 311m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_15Rnd_9x19_P226 magazines initSpeed
    {
        JCA_Magazines[]=
        {
    ...
    class JCA_MP5_9x19 // Weapon initSpeed -1 with ACE_barrelLength 225mm: 428m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_30Rnd_9x19_MP5 magazines initSpeed
    {
        JCA_Magazines[]=
        {
    ...
    class JCA_AWM_338LM // Weapon initSpeed -1 with ACE_barrelLength 685.8mm (27"): 906, 896m/s ICAO standart conditions (15°C, 1013.25 hPa, 0%) according to JCA_5Rnd_338LM_AWM magazines initSpeed
    {
        JCA_Magazines[]=
        {
...
class CfgWeapons
{
    ...
    class JCA_hgun_P320_base_F: Pistol_Base_F // P320 Compact, United States Army SIG Sauer M18 https://en.wikipedia.org/wiki/SIG_Sauer_M17
    {
        ...
        initSpeed=-1; // 361, 300m/s, 99mm barrel length, according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%), JCA 380
        magazines[]=
    ...
    class JCA_hgun_P226_base_F: Pistol_Base_F // U.S. Navy SEALs P226 MK25 https://www.sigsauer.com/p226-mk25-full-size.html
    {
        ...
        ACE_barrelTwist=250; // CIP twist https://bobp.cip-bobp.org/uploads/tdcc/tab-iv/tabivcal-en-page28.pdf
        initSpeed=-1; // 378, 311m/s, 112mm barrel length, according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%), JCA 380
        magazines[]=
        { // Priority to JCA magazines first
            "JCA_15Rnd_9x19_P226_FMJ_Mag",
            "JCA_15Rnd_9x19_P226_JHP_Mag",
    ...
    class JCA_smg_MP5_base_F: Rifle_Short_Base_F // https://www.heckler-koch.com/en/Products/Military%20and%20Law%20Enforcement/Submachine%20guns/MP5?section=variants&s=true
    {
        ...
        initSpeed=-1; // 428m/s, 225mm barrel length, according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%), JCA 375
    ...
    class JCA_hgun_Mk23_base_F: Pistol_Base_F
    {
        ...
        initSpeed=-1; // 311m/s, 149mm barrel length, according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%), JCA 300
        class WeaponSlotsInfo: WeaponSlotsInfo
        {
    ...
    class JCA_srifle_M107_base_F: Rifle_Long_Base_F
    {
        ...
        ace_overheating_closedBolt=1;
        maxZeroing=3200; // distance 12.7x99mm AMAX Mach 0.8 (272m/s) ICAO, srifle_GM6_F (Lynx) 2200, JCA 2500
        initSpeed=-1; // 838, 826, 1132, 828, 841m/s according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%)
