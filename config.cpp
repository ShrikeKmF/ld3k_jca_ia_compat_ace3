...
class CfgAmmo
{
    ...
    class JCA_B_556x45_Ball: BulletBase // M855, ACE3 https://github.com/acemod/ACE3/blob/master/addons/ballistics/CfgAmmo.hpp#L117
    {
        ...
        waterFriction=-0.3;
        caliber=0.7; // B_556x45_Ball 0.869565;
    ...
    class JCA_B_556x45_Ball_M855A1: JCA_B_556x45_Ball // M855A1 Lake City Army Ammunition Plant, 2023 article https://www.ar15.com/forums/AR-15/M855A1-Accuracy-and-Velocity-updated-/16-783286/
    {
        ACE_caliber=5.70; // https://bobp.cip-bobp.org/uploads/tdcc/tab-i/223-rem-170406-en.pdf
        ...
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=7;
        // 76°F (24°C rounded to 25°C for Ace3), 1019mB, 47%, barrel length 20": 3131fps (954m/s - 954m/s in-game) - barrel length 14.5": average 2951fps (899m/s - 900m/s in-game) from 2023 article values https://www.ar15.com/forums/AR-15/M855A1-Accuracy-and-Velocity-updated-/16-783286/
...
class CfgMagazines
{
    ...
    class JCA_30Rnd_556x45_Stanag_M995AP: JCA_30Rnd_556x45_Stanag
    {
        ...
        ammo="JCA_B_556x45_Ball_M995AP";
        mass=13.2; // Steel magazine 30 rounds (empty) 250g + 30x 12.3g (M995 cartridge weight)
        initSpeed=1030; // according to ACE_muzzleVelocities M4A1 CQB, M4A4, M4A4 EGLM 10.3" (261.62mm) / M4A1, M4A1 EGLM 14.5" (368.3mm) ICAO conditions (15°C, 1013.25hPa, 0%)
        displaynameshort="M995 AP";
    };
...
class CfgMagazineWells
{
    class STANAG_556x45
    {
        ...
        JCA_Magazines[]= // Weapon initSpeed -1 with ACE_barrelLength 508mm (20"): 926, 940, 1030, 283 m/s at ICAO standart conditions (15°C, 1013.25 hPa, 0%) according to JCA_30Rnd_556x45 magazines initSpeed
...
class CfgWeapons
{
    ...
    class JCA_arifle_M4A1_base_F: Rifle_Base_F
    {
        ...
        initSpeed=-0.942679; // 873, 886, 971, 267m/s according to ACE_muzzleVelocities at ICAO conditions (15°C, 1013.25hPa, 0%), JCA 880
        magazines[]=
        { // Priority to JCA magazines first
            "JCA_30Rnd_556x45_Stanag_Green",
            "JCA_30Rnd_556x45_Stanag",
    ...
    {
        ACE_barrelLength=368.3; // 14.5" 3D model barrel length
        initSpeed=-0.942679; // 873, 886, 971, 267m/s according to ACE_muzzleVelocities at ICAO conditions (15°C, 1013.25hPa, 0%), JCA 800
        class WeaponSlotsInfo: WeaponSlotsInfo
        {
    ...
    class JCA_arifle_M4A1_short_base_F: JCA_arifle_M4A1_base_F
    {
        ...
        initSpeed=-0.8545; // 791, 803, 880, 242m/s according to ACE_muzzleVelocities at ICAO conditions (15°C, 1013.25hPa, 0%), JCA 800
        class WeaponSlotsInfo: WeaponSlotsInfo
        {
        ...
        class Single: Single
        {
            dispersion=0.000612; // 3.74 MOA (*0.562*0.000291), 0.562 value from https://github.com/acemod/ACE3/pull/5755, JCA 0.00073 (2.51 MOA)
        };
    ...
    class JCA_arifle_M4A4_base_F: Rifle_Base_F
    {
        ...
        ACE_barrelLength=261.62; // 10.3" CQBR barrel length
        ACE_railHeightAboveBore=2.42081; // from ACE3 checkScopes.sqf
        initSpeed=-0.8545; // 791, 803, 880, 242m/s according to ACE_muzzleVelocities at ICAO conditions (15°C, 1013.25hPa, 0%), JCA 880
        magazines[]=
        { // Priority to JCA magazines first
            "JCA_30Rnd_556x45_Green_PMAG",
            "JCA_30Rnd_556x45_PMAG",
        ...
        class Single: Mode_SemiAuto
        {
            dispersion=0.000612; // 3.74 MOA (*0.562*0.000291), 0.562 value from https://github.com/acemod/ACE3/pull/5755, JCA 0.00058 (1.99 MOA)
        };
        class FullAuto: Mode_FullAuto
        {
            dispersion=0.000612; // 3.74 MOA (*0.562*0.000291), 0.562 value from https://github.com/acemod/ACE3/pull/5755, JCA 0.00058 (1.99 MOA)
