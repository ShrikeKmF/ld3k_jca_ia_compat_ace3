    ...
    class JCA_arifle_M4A1_base_F: Rifle_Base_F
    {
        ...
        class Single: Mode_SemiAuto
        {
            ...
            class StandardSound: BaseSoundModeType
            {
                soundSetShot[]=
                {
                    "JCA_M4A1_Shot_SoundSet",
                    "JCA_M4A1_Tail_SoundSet",
                    "JCA_M4A1_Tail_Interior_SoundSet"
                };
                beginwater1[]=
                {
            ...
            class SilencedSound: BaseSoundModeType
            {
                soundSetShot[]=
                {
                    "JCA_M4A1_suppressed_Shot_SoundSet",
                    "JCA_M4A1_suppressed_Tail_SoundSet",
                    "JCA_M4A1_suppressed_Tail_Interior_SoundSet"
                };
                beginwater1[]=
                {
                    "A3\Sounds_F\arsenal\weapons\Rifles\SDAR\underwater_sdar_01",
